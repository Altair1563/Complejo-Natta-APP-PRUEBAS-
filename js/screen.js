...
$(document).ready(function(){ 
    ...
    $('.accordion-trigger').click(function(){
        $(this).toggleClass('active').next().slideToggle(); // Alterna entre abrir y cerrar el contenido asociado
        return false;
    });
});
...
$(document).ready(function(){ 
    ...
    $('.accordion-trigger-footer').click(function(){
        $(this).toggleClass('active').next().slideToggle(); // Alterna entre abrir y cerrar el contenido asociado del footer
        return false;
    });
});
