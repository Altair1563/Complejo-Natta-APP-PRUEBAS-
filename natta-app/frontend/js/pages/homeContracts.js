...
const ESCUELA_LOGO_CODES = new Set(['CJ', 'HV', 'JA', 'JN', 'SC', 'MB', 'ET', 'SU']);
...
function escuelaLogoUrl(codigo) {
  ...
  if (!ESCUELA_LOGO_CODES.has(code)) return '';
  return `./assets/img/${code}.jpg`;
}
...
<div class="contract-modal-header">
  <div class="contract-modal-header__logos">
    <img src="./assets/img/logo4.png" alt="Complejo Educativo Natta" class="contract-modal-header__logo contract-modal-header__logo--natta" />
    ${escuelaImg}
  </div>
    ...
    return [
      {
        ...
        note: 'Ingresantes externos 2027: únicamente CUOTA-10 Adelanto de Reserva de vacante (2027) abonada.',
      },
      byKey.firma,
      byKey.documentacion,
      {
