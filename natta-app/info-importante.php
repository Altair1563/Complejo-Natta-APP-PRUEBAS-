    ...
    <div class="container-fluid" style="background-color:#0c3484e8;box-shadow: 0 8px 7px rgba(0, 0, 0, 1);">
        <div class="page-header" style="color:white; border-radius:20px; padding:0 10px; margin:10px 0 20px;">
            ...
            <p style="font-size:18px;">
                En esta sección se publicarán los comunicados oficiales emitidos por la Administración del Complejo Educativo Pbro. Eliseo Esteban Natta, con el objetivo de mantener a las familias debidamente informadas.<br><br>
