...
<head>
    ...
    <title>Inicio - Complejo Natta</title>
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid" style="background-color:#0c3484e8;box-shadow: 0 8px 7px rgba(0, 0, 0, 1);">
            <div class="page-header" style="color:white; border-radius:20px; padding:0 10px; margin:10px 0 20px;">
                <br>
                <h1 class="text-titles"><b>📱 Bienvenidos a la APP del Complejo Educativo Natta</b></h1><br>
                <p style="font-size:18px;">
                    ...
                    Para que sus pagos se acrediten correctamente, una vez realizado el pago es indispensable enviar el comprobante descargado completo (donde debe figurar fecha, importe, número de transacción, cuenta emisora y CBU destinatario) al correo:<strong>📧 complejo_natta@yahoo.com.ar</strong><br><br>
