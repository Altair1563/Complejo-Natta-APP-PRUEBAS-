 ...
 */
$h = 'estado_alumno_h';
$cursoFiltro = (string)$filtrosEmails['curso'];
...
<form method="get" class="filtros emails-form" id="emailsForm">
    ...
    <div class="campo">
        <label for="curso_emails" class="form-label">Curso</label>
        <select name="curso" id="curso_emails" class="form-select">
...
<?php elseif ($totalEmails === 0): ?>
    <div class="no-data">
        No se encontraron alumnos para los filtros seleccionados. Probá ajustar el curso o la búsqueda.
    </div>
<?php else: ?>
    ...
    <div class="resumen-wrapper">
        <div class="resumen">
            <div class="resumen-text">
                ...
                <?php if ($cursoFiltro !== ''): ?>
                    <span class="resumen-meta">Curso: <?php echo $h($cursoFiltro); ?></span>
                <?php endif; ?>
            </div>
        </div>
    </div>
