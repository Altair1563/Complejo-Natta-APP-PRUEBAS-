            ...
            <div class="tab-pane fade show active" id="usuarios" role="tabpanel">
                            ...
                            <div class="card-body">
                                <form method="post" action="<?= htmlspecialchars(admin_page_url('usuarios'), ENT_QUOTES, 'UTF-8') ?>">
                                    ...
                                    <div class="mb-3 js-escuela-field" id="new_escuela_wrap" hidden>
                                        ...
                                        <div class="form-text js-escuela-help-secretaria">
                                            Contratos y emails se limitan a esta escuela. En estados de cuenta podrá buscar alumnos de todo el complejo.
                                        </div>
                                        <div class="form-text js-escuela-help-directivo" hidden>
                                            Entra al mismo panel que secretaría, con la pestaña Control de Usuarios para esta escuela.
                                        </div>
                                    </div>
                                    <div class="mb-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php foreach ($usuarios as $u): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="small">
                                                        <?php if (in_array($u['rol'], ['secretaria', 'directivo'], true) && !empty($u['escuela_codigo'])): ?>
                                                            <?= htmlspecialchars(
                                ...
                                <p class="small text-muted mb-0">
                                    ...
                                    <strong>secretaria</strong>: solo <code>admin/estado_alumno.php</code>. En estados de cuenta puede consultar alumnos de todo el complejo; contratos y emails quedan limitados a la escuela asignada.
                ...
                document.querySelectorAll('.js-rol-select').forEach(function (select) {
                    function syncEscuelaField() {
                        ...
                        const helpSec = form.querySelector('.js-escuela-help-secretaria');
                        const helpDir = form.querySelector('.js-escuela-help-directivo');
                        if (helpSec) {
                            helpSec.hidden = select.value !== 'secretaria';
                        }
                        if (helpDir) {
                            helpDir.hidden = select.value !== 'directivo';
                        }
                    }
