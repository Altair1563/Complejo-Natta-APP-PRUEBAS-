<form method="get" class="filtros curso-form" id="cursoFormRevision">
    ...
    <div class="campo">
        <label for="curso_revision" class="form-label">Curso de <?php echo estado_alumno_h($escuelas[$escuelaActiva]); ?></label>
        <select name="curso" id="curso_revision" class="form-select">
