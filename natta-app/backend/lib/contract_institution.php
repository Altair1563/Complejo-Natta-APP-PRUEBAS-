...
/**
 * Código de curso (ET, MB) → segmento del nombre de archivo HTML (Contrato_IDET_2027_v1.html).
 */
...
/**
 * Nombre de versión / plantilla HTML (ej. Contrato_CJ_2027_v1).
 */
...
function contrato_public_app_root_url(): string
{
    ...
    $url = defined('APP_PUBLIC_URL') ? APP_PUBLIC_URL : 'https://complejonatta.com/natta-app/index.php';
...
function contrato_reglamento_info_desde_codigo(string $codigo): array
{
    ...
    if ($codigo === 'SU') {
        return [
            'modal_link_label' => 'Leer REGLAMENTO INTERNO 2027',
            'email_link_label' => 'Reglamento interno 2027',
            'filename' => 'Reglamento interno 2027 - Instituto Superior.pdf',
        ];
    }
    ...
    return [
        ...
        'filename' => 'Reglamento CPEEN 2027 - Complejo Natta.pdf',
    ];
}
