...
/**
 * Ruta del template HTML según contract_version (ej. Contrato_JN_2027_v1).
 */
...
{
    static $labels = [
        'JN' => 'Instituto Jesús Niño',
        'CJ' => 'Jardín La Casita de Jesús',
        'HV' => 'Jardín La Hormiguita Viajera',
        'JA' => 'Jardín De La Alegría',
        'SC' => 'Instituto Santa Cruz',
        'MB' => 'Instituto Manuel Belgrano',
        'ET' => 'Instituto de Educación Técnica "Manuel Belgrano"',
        'SU' => 'Instituto de Educación Superior "Manuel Belgrano"',
    ]; 
    ...
    return $inst !== '' ? $inst : 'Establecimiento educativo';
}
...
/** Códigos de escuela con logo en assets/img/{CODIGO}.jpg */
function contrato_escuela_logo_codes(): array
{
    return ['CJ', 'HV', 'JA', 'JN', 'SC', 'MB', 'ET', 'SU'];
}
...
function contrato_encabezado_institucion_lineas(string $codigo): array
{
    static $lineas = [
        'JN' => [
            'Complejo Educativo "Pbro. Eliseo Esteban Natta"',
            'Perteneciente al Obispado de Lomas de Zamora',
            'Instituto "Jesús Niño" – DIPRIGEP Nº 838',
            'Distrito de Ezeiza (130) - Región 5ª',
            'Pbro. Eliseo Esteban Natta 241(ex 255) - B1806FZE - Tristán Suárez Buenos Aires - Argentina',
            'Tel.: 4234-9710 inter. 42 Fax 4234-9341',
        ],
        'CJ' => [
            'Complejo Educativo "Pbro. Eliseo Esteban Natta" - Perteneciente al Obispado de Lomas de Zamora',
            'Jardín La Casita de Jesús – DIPREGEP 3136',
            'Distrito de Ezeiza (130) - Región 5',
            'Paraguay 846 Ezeiza Buenos Aires - Argentina',
            'Tel.: 7514-6358 - lacasitadejesus3136@gmail.com',
        ],
        'HV' => [
            'Complejo Educativo "Pbro. Eliseo Esteban Natta" - Perteneciente al Obispado de Lomas de Zamora',
            'Jardín de Infantes "La Hormiguita Viajera" – DIEGEP Nº 1303',
            'Distrito de Ezeiza (130) - Región 5',
            'Pbro. Eliseo Esteban Natta 285 - B1806FZE - Tristán Suárez Buenos Aires - Argentina',
            'Tel.: 7548-5685 - jardinlhv@gmail.com',
        ],
        'ET' => [
            'COMPLEJO EDUCATIVO',
            '"Pbro. Eliseo Esteban Natta"',
            'Perteneciente al OBISPADO de Lomas de Zamora',
            'Instituto de Educación Técnica',
            '"Manuel Belgrano" - DIPREGEP N° 4182',
            'Pbro. Eliseo E. Natta 285 CP. B1806FZE – Tristán Suárez - Distrito de Ezeiza',
            'Tel.: 7559-8137 - Mail: idet4182@yahoo.com.ar',
        ],
        'MB' => [
            'Obispado de Lomas de Zamora',
            'Complejo Educativo Pbro. Eliseo Esteban Natta',
            'Instituto "Manuel Belgrano"',
            'Nivel Medio - DIPREGEP 4189',
            'Pbro. E. E. Natta 241 (ex 255) Tristán Suárez CP.1806',
            'Tel. 7558-3230 Distrito de Ezeiza – Región 5ª - CUE 0611330-0',
        ],
        'JA' => [
            'Complejo Educativo "Pbro. Eliseo Esteban Natta" - Perteneciente al Obispado de Lomas de Zamora',
            'Jardín de la Alegría – DIPREGEP 2975',
            'Caracas y P. de Mendoza - B1806FZE - Tristán Suárez Buenos Aires - Argentina',
            'Tel.: 7532-5028',
            'jardin91alegria@gmail.com',
        ],
        'SC' => [
            'Complejo Educativo "Pbro. Eliseo Esteban Natta" - Perteneciente al Obispado de Lomas de Zamora',
            'Instituto "Santa Cruz" – DIPREGEP 1639',
            'Distrito de Ezeiza (130) - Región 5ª',
            'Av. Argentina y Pedro de Mendoza - B1806DLZ - Tristán Suárez Buenos Aires - Argentina',
            'Tel.: 2132-1707 - santacruz1639@yahoo.com.ar',
        ],
        'SU' => [
            'Complejo Educativo Pbro. Eliseo Esteban Natta',
            'Instituto Superior Manuel Belgrano',
            'DIPREGEP 4178',
            'Pbro. Natta 241 Tristán Suárez Tel: 7558-3230',
            'eMail: ismb4178@yahoo.com.ar',
        ],
    ];
...
/**
 * Bloque de logos (Complejo Natta + escuela) con URLs absolutas para impresión y vista web.
 */
function contrato_html_logos_header(array $data): string
{
    ...
    $nattaSrc = $base . 'logo4.png';
    $escuelaImg = '';
    if (in_array($codigo, contrato_escuela_logo_codes(), true)) {
        $escuelaSrc = $base . rawurlencode($codigo . '.jpg');
        $escuelaImg = '<img src="' . htmlspecialchars($escuelaSrc, ENT_QUOTES, 'UTF-8')
            . '" alt="Logo ' . htmlspecialchars($codigo, ENT_QUOTES, 'UTF-8')
            . '" class="contract-doc-logo contract-doc-logo--escuela" />';
    }
    ...
    return '<div class="contract-doc-logos">'
        ...
        . '<img src="' . htmlspecialchars($nattaSrc, ENT_QUOTES, 'UTF-8')
        . '" alt="Complejo Educativo Natta" class="contract-doc-logo contract-doc-logo--natta" />'
        . $escuelaImg
        . '</div>'
        . $infoHtml
        . '</div>';
