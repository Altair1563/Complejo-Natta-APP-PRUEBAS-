...
<head>
    ...
    <title>Política de Privacidad — Natta App</title>
...
<body class="privacy-page">
    <header class="privacy-header">
        <a href="/natta-app/index.php">&larr; Volver al inicio de sesión</a>
    </header>
    <main class="privacy-scroll" id="privacy-main">
        <article class="privacy-card">
            ...
            <p>
                El <strong>responsable</strong> del archivo, banco de datos o tratamiento de datos personales es el titular de la base que define las finalidades y medios del tratamiento. A los fines de esta Política, el responsable es el <strong>Instituto Jesús Niño</strong> (en adelante, “Complejo Natta” o “el Establecimiento”), que opera bajo el nombre comercial <strong>Complejo Educativo «Pbro. Eliseo Esteban Natta»</strong>, perteneciente al <strong>Obispado de Lomas de Zamora</strong>, y administra en forma integrada las siguientes unidades educativas del complejo:
            </p>
            <ul>
                <li>Jardín de Infantes «La Hormiguita Viajera»</li>
                <li>«Jardín de la Alegría»</li>
                <li>Jardín de Infantes «La Casita de Jesús»</li>
                <li>Jardín de Infantes «La Milagrosa»</li>
                <li>Instituto «Jesús Niño»</li>
                <li>Instituto «Santa Cruz»</li>
                <li>Instituto «Manuel Belgrano»</li>
                <li>Instituto de Educación Técnica «Manuel Belgrano»</li>
                <li>Instituto de Educación Superior «Manuel Belgrano»</li>
                <li>Instituto «Niño de Belén»</li>
            </ul>
            <p>Datos de identificación del responsable:</p>
            <ul>
                <li><strong>Razón social / denominación legal:</strong> Instituto Jesús Niño.</li>
                <li><strong>Nombre comercial / denominación de uso:</strong> Complejo Educativo «Pbro. Eliseo Esteban Natta».</li>
                <li><strong>Afiliación institucional:</strong> perteneciente al Obispado de Lomas de Zamora.</li>
                <li><strong>C.U.I.T.:</strong> 30-64604220-4.</li>
                <li><strong>Domicilio real y constituido</strong> (para notificaciones y ejercicio de derechos): Pbro. Eliseo Esteban Natta 285, B1806FZE, Tristán Suárez, Provincia de Buenos Aires, Argentina — Distrito de Ezeiza (130), Región 5.</li>
                <li><strong>Correo electrónico institucional y para reclamos en materia de protección de datos personales:</strong> <a href="mailto:nattadomicilioelectronico@gmail.com">nattadomicilioelectronico@gmail.com</a>.</li>
                <li><strong>Sitio web:</strong> <a href="https://www.complejonatta.com.ar" target="_blank" rel="noopener noreferrer">www.complejonatta.com.ar</a>.</li>
            </ul>
            ...
            <p>
                Para consultas generales sobre esta Política o para iniciar un trámite de ARCO ante el Establecimiento, puede utilizarse el correo <a href="mailto:administracion@complejonatta.com">administracion@complejonatta.com</a> y los canales presenciales o telefónicos de secretaría indicados en el apartado 1. Se recomienda también el uso de la dirección de correo electrónico especialmente dispuesta para derechos ARCO: <a href="mailto:nattadomicilioelectronico@gmail.com">nattadomicilioelectronico@gmail.com</a>.
            </p>
