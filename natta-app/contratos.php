        ...
        <div class="contratos-info-box">
            ...
            <div class="contratos-aviso-noviembre" role="note" aria-label="Requisito para habilitar la firma">
                ...
                <ul class="contratos-intro-list">
                    ...
                    <li>En alumnos <strong>ingresantes 2027</strong> se habilita únicamente cuando figure pagado el <strong>ADELANTO RV 2027</strong> (Adelanto de Reserva de vacante).</li>
                </ul>
            </div>
