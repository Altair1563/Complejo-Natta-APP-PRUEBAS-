...
<div class="page-wrapper">
    ...
    <span id="readyBox" style="display:none;align-items:center;gap:6px;">
        ...
        <form method="get" class="filtros" action="<?= htmlspecialchars($lfFormAction, ENT_QUOTES, 'UTF-8') ?>">
            ...
            <div class="campo">
                <label for="escuela">Sala / curso</label>
                <select name="escuela" id="escuela">
                    ...
                    foreach (tenant_escuelas_catalog() as $escCode => $escName):
                    ?>
                    <option value="<?php echo $lfH($escCode); ?>" <?php echo $escuelaFiltro === $escCode ? 'selected' : ''; ?>><?php echo $lfH($escCode . ' — ' . $escName); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="campo">
                ...
                <input type="text" name="buscar" id="buscar"
                       ...
                       placeholder="Ej: MARTINEZ, 10144/01, SCI">
            </div>
