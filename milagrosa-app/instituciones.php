    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid" style="background-color:#0c3484e8;box-shadow: 0 8px 7px rgba(0, 0, 0, 1);">
            <div class="page-header" style="color:white; border-radius:20px; padding:0 10px; margin:10px 0 20px;">
                ...
                <p style="font-size:18px;">
                    En esta sección encontrará los datos de contacto oficiales de las distintas instituciones que forman parte del Jardin de Infantes La Milagrosa.<br>
        ...
        <div class="container-fluid contacto-wrapper">
            ...
            <div class="contacto-card admin-card">
                ...
                <p><b>📧 Correo:</b> <a href="mailto:jardindeinfanteslamilagrosa@hotmail.com">jardindeinfanteslamilagrosa@hotmail.com</a></p>
                ...
                <p><b>⏰ Horario:</b> 9:00 a 12:00hs</p>
                <p><b>📍 Dirección:</b> Monti 1418, 9 de Abril, Provincia de Bs. As</p>
                <p><b>📞 Tel:</b> 1124709331</p>
            </div><br>

            <h3 class="contacto-subtitulo">🧾 Secretaría</h3>
            ...
            <div class="contacto-grid">
                <div class="contacto-card">
                    ...
                    <p><b>⏰ Horario:</b> 9:00 a 12:00hs</p>
                    <p><b>📍 Dirección:</b> Monti 1418, 9 de Abril, Provincia de Bs. As</p>
                    <p><b>📧 Email:</b> <a href="mailto:jardindeinfanteslamilagrosa@hotmail.com">jardindeinfanteslamilagrosa@hotmail.com</a></p>
                </div>
            </div>
        </div>
    </section>
