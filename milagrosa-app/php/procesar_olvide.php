...
$reset_link = "https://complejonatta.com/milagrosa-app/php/restablecer_password.php?token=" . urlencode($token) . "&email=" . urlencode($email);
...
try {
    ...
    // Contenido
    $mail->isHTML(true);
    $mail->Subject = 'Recuperación de contraseña - Jardin de Infantes La Milagrosa';
    $mail->Body    = "
        ...
        <br>
        <p>Saludos,<br>Jardin de Infantes La Milagrosa</p>
    ";
