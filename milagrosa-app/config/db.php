...
if (!defined('TENANT_ID')) {
    define('TENANT_ID', (string)($tenant['id'] ?? 'milagrosa'));
}
if (!defined('TENANT_SLUG')) {
    define('TENANT_SLUG', (string)($tenant['slug'] ?? 'milagrosa-app'));
}
if (!defined('TENANT_NAME')) {
    define('TENANT_NAME', (string)($tenant['name'] ?? 'Jardin de Infantes La Milagrosa'));
}
