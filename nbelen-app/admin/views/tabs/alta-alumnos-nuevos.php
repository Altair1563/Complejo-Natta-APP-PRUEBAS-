...
$aanCursoAlta = tenant_curso_alta_nuevos();
                        ...
                        <form method="post" action="<?= $aanH($aanFormAction) ?>">
                            ...
                            <section class="aan-section">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3"><label>Curso</label><input name="codigo_curso" class="form-control" value="<?= $aanH($aanCursoAlta) ?>" readonly></div>
