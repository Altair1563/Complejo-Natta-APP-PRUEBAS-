                                    ...
                                    <?php if ($institucionUnica): ?>
                                        <div class="mb-3 js-institucion-field" hidden>
                                            <div class="alert alert-info py-2 mb-0">
                                                Acceso a todo Nuestra Señora de Itati: Jardín (JB), Primaria (PB) y Secundaria (SB).
                                            </div>
                                        </div>
                                    <?php else: ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                                        ...
                                                        <form method="post" class="row g-2 p-2 bg-light rounded" action="<?= htmlspecialchars(admin_page_url('usuarios'), ENT_QUOTES, 'UTF-8') ?>">
                                                            ...
                                                            <?php if ($institucionUnica): ?>
                                                                <div class="col-md-3 js-institucion-field" <?= in_array($u['rol'], ['secretaria', 'directivo'], true) ? '' : 'hidden' ?>>
                                                                    ...
                                                                    <div class="form-control form-control-sm bg-light">Todo Nuestra Señora de Itati</div>
                                                                </div>
                                                            <?php else: ?>
                                ...
                                <p class="small text-muted mb-0">
                                    ...
                                    <strong>secretaria</strong>: acceso a todos los cursos de Nuestra Señora de Itati desde <code>admin/estado_alumno.php</code>.
