...
function contrato_codigo_institucion_desde_curso(?string $curso): ?string
{
    ...
    $codigo = tenant_escuela_desde_curso($curso);
...
/**
 * Código de nivel (JB, PB, SB) → segmento del nombre de archivo HTML (Contrato_JB_2027_v1.html).
 */
...
/**
 * Nombre de versión / plantilla HTML (ej. Contrato_JB_2027_v1).
 */
...
function contrato_public_app_root_url(): string
{
    ...
    $url = defined('APP_PUBLIC_URL') ? APP_PUBLIC_URL : 'https://complejonatta.com/nbelen-app/index.php';
...
{
    // Un único reglamento para JB / PB / SB (Nuestra Señora de Itati / INB).
    return [
        'modal_link_label' => 'Leer REGLAMENTO INSTITUCIONAL 2027',
        'email_link_label' => 'Reglamento CPEEN 2027',
        'filename' => 'Reglamento Interno - CPEEN 2027 - INB.pdf',
    ];
}
