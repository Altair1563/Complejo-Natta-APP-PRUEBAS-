...
require_once __DIR__ . '/../lib/familia_context.php';
...
try {
    ...
    $ctx = familia_ctx_build($conn, (int)$nroFamilia);
    $conn->close();
    echo json_encode(array_merge(['ok' => true], $ctx), JSON_UNESCAPED_UNICODE);
} catch (Throwable $e) {
    error_log('ajax_familia_context: ' . $e->getMessage());
    http_response_code(500);
    echo json_encode(['ok' => false, 'msg' => 'Error al cargar datos']);
}
