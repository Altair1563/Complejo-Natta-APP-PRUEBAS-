...
<head>
    ...
    <title>Política de Privacidad — Complejo Nuestra Señora de Itatí</title>
...
<body class="privacy-page">
    <header class="privacy-header">
        <a href="/nbelen-app/index.php">&larr; Volver al inicio de sesión</a>
    </header>
    <main class="privacy-scroll" id="privacy-main">
        <article class="privacy-card">
            ...
            <p>
                El <strong>responsable</strong> del archivo, banco de datos o tratamiento de datos personales es el titular de la base que define las finalidades y medios del tratamiento. A los fines de esta Política, el responsable es el <strong>Complejo Educativo Nuestra Señora de Itatí</strong> (en adelante, “Complejo Educativo Nuestra Señora de Itatí” o “el Establecimiento”), que opera bajo el nombre comercial <strong>COMPLEJO EDUCATIVO NTRA SRA DE ITATI</strong>, perteneciente al <strong>Obispado de Lomas de Zamora</strong>, y administra en forma integrada las siguientes unidades educativas del complejo:
            </p>
            <ul>
                <li>Jardín de Infantes «Pinocho»</li>
                <li>Primaria Nuestra Señora de Itatí</li>
                <li>Secundaria Nuestra Señora de Itatí</li>
            </ul>
            <p>Datos de identificación del responsable:</p>
            <ul>
                <li><strong>Razón social / denominación legal:</strong> Complejo Educativo Nuestra Señora de Itatí.</li>
                <li><strong>Nombre comercial / denominación de uso:</strong> COMPLEJO EDUCATIVO NTRA SRA DE ITATI.</li>
                ...
                <li><strong>Domicilio real y constituido</strong> (para notificaciones y ejercicio de derechos): Las Heras 632, Carlos Spegazzini, Provincia de Buenos Aires, Argentina.</li>
                <li><strong>Correo electrónico institucional y para reclamos en materia de protección de datos personales:</strong> <a href="mailto:cobranzasinb@gmail.com">cobranzasinb@gmail.com</a>.</li>
            ...
            <p>
                Para consultas generales sobre esta Política o para iniciar un trámite de ARCO ante el Establecimiento, puede utilizarse el correo <a href="mailto:cobranzasinb@gmail.com">cobranzasinb@gmail.com</a> y los canales presenciales o telefónicos de secretaría indicados en el apartado 1. Se recomienda también el uso de la dirección de correo electrónico especialmente dispuesta para derechos ARCO: <a href="mailto:cobranzasinb@gmail.com">cobranzasinb@gmail.com</a>.
            </p>
