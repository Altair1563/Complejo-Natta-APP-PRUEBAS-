...
$reset_link = "https://complejonatta.com/nbelen-app/php/restablecer_password.php?token=" . urlencode($token) . "&email=" . urlencode($email);
...
try {
    ...
    // Contenido
    $mail->isHTML(true);
    $mail->Subject = 'Recuperación de contraseña - Nuestra Señora de Itati';
    $mail->Body    = "
        ...
        <br>
        <p>Saludos,<br>Nuestra Señora de Itati</p>
    ";
