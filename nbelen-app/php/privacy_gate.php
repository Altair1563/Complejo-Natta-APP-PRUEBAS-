...
<head>
    ...
    <title>Política de privacidad — Nuestra Señora de Itati App</title>
...
<body style="margin:0;background:#111;">
    <div class="pg-overlay" role="dialog" aria-modal="true" aria-labelledby="pg-title">
        <div class="pg-dialog">
            ...
            <p>
                <a href="/nbelen-app/politica-privacidad.php" target="_blank" rel="noopener noreferrer">Leer Políticas de Privacidad</a>
            </p>
            <?php if ($error_msg !== ''): ?>
