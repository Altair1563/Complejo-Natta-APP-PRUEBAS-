        ...
        <div class="full-box dashboard-sideBar-ct">
            ...
            <div class="full-box dashboard-sideBar-UserInfo">
                <figure class="full-box">
                    <img src="./assets/img/LogoNbelen.jpg" alt="UserIcon" />
                    <figcaption class="text-center text-titles">
                        <b>Instituto Nuestra Señora de Itati</b>
                    </figcaption>
                </figure>
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid" style="background-color:#0c3484e8;box-shadow: 0 8px 7px rgba(0, 0, 0, 1);">
            <div class="page-header" style="color:white; border-radius:20px; padding:0 10px; margin:10px 0 20px;">
                ...
                <p style="font-size:18px;">
                    En esta sección encontrará los datos de contacto oficiales de las distintas instituciones que forman parte de Nuestra Señora de Itati.<br>
        ...
        <div class="container-fluid contacto-wrapper">
            ...
            <div class="contacto-card admin-card">
                ...
                <p><b>📧 Correo:</b> <a href="mailto:cobranzasinb@gmail.com">cobranzasinb@gmail.com</a></p>
                ...
                <p><b>📍 Dirección:</b> Las Heras 632, Carlos Spegazzini</p>
            </div><br>

            <h3 class="contacto-subtitulo">🧾 Secretarías</h3>

            <!-- Grid de niveles Nuestra Señora de Itati -->
            <div class="contacto-grid">
                <div class="contacto-card">
                    <h4>🧒 Jardín de Infantes Pinocho</h4>
                    <p><b>Cursos:</b> 1AJ, 1BJ, 2AJ, 2BJ, 3AJ, 3BJ</p>
                    <p><b>Secretaría:</b> Completar horario</p>
                    <p><b>📞 Tel:</b> 2098-5488</p>
                    <p><b>📧 Email:</b> Completar</p>
                    <p><b>📍 Ubicación:</b> Las Heras 608, Carlos Spegazzini</p>
                </div>

                <div class="contacto-card">
                    <h4>🎒 Primaria Nuestra Señora de Itati</h4>
                    <p><b>Cursos:</b> 1AP–6BP</p>
                    <p><b>Secretaría:</b> Completar horario</p>
                    <p><b>📞 Tel:</b> Completar</p>
                    <p><b>📧 Email:</b> Completar</p>
                    <p><b>📍 Ubicación:</b> Completar</p>
                </div>

                <div class="contacto-card">
                    <h4>📘 Secundaria Nuestra Señora de Itati</h4>
                    <p><b>Cursos:</b> 1AS, 2AS, 2BS, 3AS, 3BS, 4AS, 5AS, 6AS</p>
                    <p><b>Secretaría:</b> Completar horario</p>
                    <p><b>📞 Tel:</b> Completar</p>
                    <p><b>📧 Email:</b> Completar</p>
                    <p><b>📍 Ubicación:</b> Completar</p>
                ...
                <details style="border:1px solid #eee;border-radius:12px;padding:15px" open>
                    ...
                    <div style="margin-top:12px">
                        <div class="banco-info">
                            ...
                            <div>
                                <p><strong>Titular:</strong> COMPLEJO EDUCATIVO NTRA SRA DE ITATI</p>
                                <p><strong>CBU:</strong> <span id="cbuText">0140090801518401415855</span> <button id="btnCopiarCBU" style="margin-left:8px;padding:4px 8px;border:1px solid #0c3484;border-radius:4px;background:#fff;cursor:pointer">📋 Copiar</button></p>
