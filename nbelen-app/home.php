...
<head>
    ...
    <title>Inicio - Complejo Nuestra Señora de Itati</title>
            ...
            <div class="full-box dashboard-sideBar-UserInfo">
                <figure class="full-box">
                    ...
                    <figcaption class="text-center text-titles">
                        <b>Complejo Nuestra Señora de Itati</b>
                    </figcaption>
                </figure>
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid" style="background-color:#0c3484e8;box-shadow: 0 8px 7px rgba(0, 0, 0, 1);">
            <div class="page-header" style="color:white; border-radius:20px; padding:0 10px; margin:10px 0 20px;">
                <br>
                <h1 class="text-titles"><b>📱 Bienvenidos a la APP del Complejo Nuestra Señora de Itati</b></h1><br>
                <p style="font-size:18px;">
                    ...
                    Para que sus pagos se acrediten correctamente, una vez realizado el pago es indispensable enviar el comprobante descargado completo (donde debe figurar fecha, importe, número de transacción, cuenta emisora y CBU destinatario) al correo:<strong>📧 cobranzasinb@gmail.com</strong><br><br>
                ...
                <div style="padding-right:5px;padding-left: 5px; border-radius:20px; box-shadow:0 4px 7px rgba(0,0,0,1); background-color:#082359;" class="container-fluid">
                    <div class="row-mediosdepago">
                        <div class="col-mediosdepago">
                            ...
                            * TITULAR: COMPLEJO EDUCATIVO NTRA SRA DE ITATI<br>
                            * CBU: 0140090801518401415855<br>
                        ...
                        <div class="banco-info">
                            ...
                            <div>
                                <div>
                                    ...
                                    <p><strong>CBU:</strong>
                                        <span id="cbuText">0140090801518401415855</span>
